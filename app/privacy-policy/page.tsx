export default function PrivacyPolicyPage() {
  return (
    <main className='min-h-screen bg-white text-gray-900 selection:bg-orange-500 selection:text-white px-6 mt-18 py-12'>
      <div className='max-w-4xl mx-auto'>
        <h1 className='text-5xl font-black uppercase mb-8'>Privacy Policy</h1>
...
function PrivacyPolicyContent() {
  return (
    <>
      ...
      <p>
        This Privacy Policy describes how Hose Draggers Inc. (the "Site", "we",
        "us", or "our") collects, uses, and discloses your personal information
        when you visit, use our services, or make a purchase from
        hosedraggers.ca (the "Site") or otherwise communicate with us
      ...
      <p>
        Information We Collect Directly from You To provide the Services, we
        ...
        that we collect and use varies depending on how you interact with us.
      </p>
      ...
      <p>
        ...
        orders, to send notifications to you related to you account, purchases,
        returns, exchanges or other transactions, to create, maintain and
        otherwise manage your account, to arrange for shipping, facilitate any
        returns and exchanges and to enable you to post reviews.
      </p>
      ...
      <p>
        ...
        message or postal mail, and to show you advertisements for products or
      ...
      <p>
        ...
        Services. This is in our legitimate interests in order to be responsive
      ...
      <p>
        ...
        Shopify, see https://www.shopify.com/legal/cookies. We use Cookies to
        power and improve our Site and our Services (including to remember your
        ...
        administer, improve and optimize the Services).
      </p>
      ...
      <p>
        ...
        our Site and other websites. Most browsers automatically accept Cookies
        by default, but you can choose to set your browser to remove or reject
        Cookies through your browser controls. Please keep in mind that removing
        or blocking Cookies can negatively impact your user experience and may
        cause some of the Services, including certain features and general
        functionality, to work incorrectly or no longer be available.
        Additionally, blocking Cookies may not completely prevent how we share
      ...
      <ul>
        ...
        <li>
          Commercial information such as order information, shopping information
      ...
      <p>
        ...
        purposes of inferring characteristics about you. [[NOTE TO MERCHANT-
        INSERT THE FOLLOWING PARAGRAPH AND LISTS IF USING SHOPIFY'S AD SERVICES
        SUCH AS SHOPIFY AUDIENCES OR ENGAGING IN ANY OTHER ACTIVITY THAT MAY BE
        CONSIDERED "SELLING" OR "SHARING" PERSONAL INFORMATION OR PROCESSING
      ...
      <p>
        Information you provide on public or semipublic venues, including
