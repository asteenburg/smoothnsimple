...
import { CreditCard, PaymentForm as SquareProvider } from "react-square-web-payments-sdk";
import AOS from "aos";
...
export default function Shop() {
  ...
  const [purchaseType, setPurchaseType] = useState<"gift_card" | "prepay">("gift_card");
    ...
    <div className="min-h-screen bg-black text-white selection:bg-pink-500/30">
      ...
      <main className="max-w-6xl mx-auto py-12 px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 space-y-12" data-aos="fade-right">
            {/* 01. Selection */}
            <section>
