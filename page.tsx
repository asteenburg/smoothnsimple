      ...
      <section className="relative h-[75vh] md:h-[85vh] w-full flex items-center justify-center overflow-hidden bg-zinc-950">
        ...
        <div className="relative z-20 text-center px-6" data-aos="zoom-in">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
            <Link
              href="/booking"
              className="w-full md:w-auto bg-pink-600 hover:bg-pink-700 text-white px-6 md:px-10 py-4 rounded-full font-bold transition-all transform active:scale-95 text-center"
            >
              Book Appointment
            </Link>
            <Link
